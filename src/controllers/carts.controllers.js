...
const addProductToCart = async (req, res, next) => {
    ...
    try {
        ...
        const one = await cartsManager.addProductToCart(product_id, user_id, quantity)
        res.status(201).json({
            method: req.method,
            url: req.url,
            response: one
...
export { addProductToCart, readProductsFromUser, updateQuantity, removeProductFromCart, totalToPay }
